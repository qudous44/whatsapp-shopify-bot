                ...
                for (const update of updates) {
                                try {
                                  ...
                                  if (votedOption) {
                                                      ...
                                                      // Fallback: if we have stored options but hash matching failed, use first option
                                                    // This handles deselect/reselect edge cases
                                                    console.log('[POLL] PATH 2: Hash matching failed. PollUpdates:', JSON.stringify(update.update.pollUpdates).substring(0, 200));
                                  }
                                } catch (e) {
